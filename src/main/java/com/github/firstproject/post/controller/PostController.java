...
public class PostController {
    ...
    @Operation(summary = "게시판 작성", description = "게시물을 새롭게 만들 수 있는 API 입니다.")
    @PostMapping("/posts")
    public ResponseEntity<?> postWrite(@RequestBody PostDto postDto){
        ...
        return ResponseEntity.ok(new MsgResponseDto("게시물이 작성되었습니다.", HttpStatus.OK.value()));
    }

    @Operation(summary = "게시판 상세조회", description = "게시물을 상세 조회할 수 있는 API 입니다.")
    @GetMapping("/posts")
    public void getDetailPost(@RequestParam Long postId){
